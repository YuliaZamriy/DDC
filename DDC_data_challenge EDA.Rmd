...
- After proper analysis, the final output to stakeholders would contain a list of factors they can control with assigned level of importance. Also, I would work with my team to build a simulation that allows to create different scenarios for controllable/non-controllable factors and respective impact on the main KPI.
